...
(deftest distify-github-tests
  (let ((source (make-source :github
    ...
    (let ((distinfo.txt (merge-pathnames #P"quri.txt" *tmp-directory*))
          (software (merge-pathnames #P"softwares/quri-adb6d04f1b9ea99fa7f18044df4c86b6c68023af" *tmp-directory*))
          (archive (merge-pathnames #P"archives/quri-adb6d04f1b9ea99fa7f18044df4c86b6c68023af.tar.gz" *tmp-directory*))
      ...
      (ok (equal (uiop:read-file-string distinfo.txt)
                 "name: quri
version: github-adb6d04f1b9ea99fa7f18044df4c86b6c68023af
distinfo-subscription-url: qlot://localhost/quri.txt
release-index-url: qlot://localhost/quri/github-adb6d04f1b9ea99fa7f18044df4c86b6c68023af/releases.txt
system-index-url: qlot://localhost/quri/github-adb6d04f1b9ea99fa7f18044df4c86b6c68023af/systems.txt
"))
      (ok (equal (uiop:read-file-string releases.txt)
                 "# project url size file-md5 content-sha1 prefix [system-file1..system-fileN]
quri qlot://localhost/archives/quri-adb6d04f1b9ea99fa7f18044df4c86b6c68023af.tar.gz 70532 fcfcb5d96ee6e34a37548be23984382f 2fbd8df6afd6fa4ac585da3ee17128ddd411061f quri-adb6d04f1b9ea99fa7f18044df4c86b6c68023af quri.asd quri-test.asd
"))
      (ok (equal (uiop:read-file-string systems.txt)
                 "# project system-file system-name [dependency1..dependencyN]
quri quri-test quri-test prove prove-asdf quri
quri quri quri alexandria babel cl-utilities split-sequence
")))))
